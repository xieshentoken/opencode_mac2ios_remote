...
struct ProviderKeyView: View {
    ...
    private func usageURL(for providerID: String) -> URL? {
        ...
        case "opencode", "opencode-go":
            // Never embed a user-specific workspace identifier in a release.
            // The public landing page lets each signed-in user select their
            // own workspace without leaking the publisher's account metadata.
